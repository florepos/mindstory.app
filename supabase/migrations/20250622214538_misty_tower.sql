/*
  # Enhanced Goal Tracking Schema Update

  1. New Features
    - Countable goals with quantity tracking
    - Privacy levels for goals (private, friends_challenge, public_challenge)
    - Challenge functionality with participants
    - Enhanced goal metrics and units
  ...
  3. Performance
    ...
    - Optimized queries for challenge data
*/
...
-- Insert default metrics (using ON CONFLICT to avoid duplicates)
