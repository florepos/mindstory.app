/*
  ...
  1. New Tables
    ...
    - `goal_metrics` - Define measurement units for goals
  
  2. Enhanced Goals Table
    - Add `is_countable` boolean for quantity tracking
    - Add `target_unit` for measurement units
    - Add challenge-specific fields (start_date, end_date, max_participants)
    - Update goal_type constraint to support new privacy levels
  
  3. Enhanced Goal Entries
    - Add `quantity` for countable goals
    - Add `duration_minutes` for time-based tracking
    - Add `notes` for additional context
  
  4. Security
    - Enable RLS on new tables
    - Add policies for challenge visibility and participation
    - Update existing policies for new privacy levels
  
  5. Performance
    - Add indexes for efficient queries
    - Add trigger for automatic progress tracking
*/
