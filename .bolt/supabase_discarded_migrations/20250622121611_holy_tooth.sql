/*
  ...
  1. Schema Updates
    ...
    - Add public challenges and friend challenges support
    - Add goal metrics and units

  2. New Tables
    - goal_participants - Track users participating in public/friend challenges
    - goal_metrics - Define measurement units for countable goals

  3. Security
    - Update RLS policies for new privacy levels
    - Add policies for public challenge viewing
    - Ensure proper access control for friend challenges

  4. Features
    - Privacy levels: private, friends_challenge, public_challenge
    - Countable toggle with quantity/duration tracking
    - Target metrics with units (minutes, completions, etc.)
    - Public challenge feed support
...
DO $$
BEGIN
  -- Update goal_type to use new privacy levels
  IF EXISTS (
    ...
    -- Add new constraint with privacy levels
